...
<DIV id=header class=wrap>
    ...
    <DIV class=search>欢迎：${sessionScope.user.name}<LABEL class="ui-green searchs"><a href="goFabu"
                                                                                     title="">发布房屋信息</a></LABEL>
        ...
        <TABLE class=house-list>
            ...
            <c:forEach items="${pageInfo.list}" var="h">
                <TR>
                    ...
                    <TD class=house-type><LABEL class=ui-green><INPUT onclick="location.href='goUpdate?id=${h.id}'" value="修    改" type=button
                                                                      name=search></LABEL></TD>
                    <TD class=house-price><LABEL class=ui-green><INPUT onclick="location.href='deleteHouse?id=${h.id}'" value="删    除" type=button name=search></LABEL>
                    </TD>
                </TR>
            </c:forEach>
            </TBODY>
